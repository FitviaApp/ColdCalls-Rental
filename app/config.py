...
class Settings(BaseSettings):
    ...
    AI_OPENAI_MAX_COMPLETION_TOKENS: int = 80
    ELEVENLABS_TTS_MODEL: str = "eleven_multilingual_v2"
    ELEVENLABS_LIVE_MODEL: str = "eleven_flash_v2_5"
    ...
    AI_HTTP_CONNECT_TIMEOUT_SECONDS: float = 5.0
    AI_HTTP_READ_TIMEOUT_SECONDS: float = 20.0
    AI_HTTP_WRITE_TIMEOUT_SECONDS: float = 10.0
    AI_HTTP_MAX_RETRIES: int = 2
    AI_HTTP_RETRY_BACKOFF_SECONDS: float = 0.5
    AI_HTTP_MAX_RETRIES_LIVE: int = 1
    AI_HTTP_RETRY_BACKOFF_SECONDS_LIVE: float = 0.15
